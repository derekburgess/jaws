"""Legacy finder runtime retained behind the thin public compatibility adapter."""
...
from jaws.services import legacy_compat as _comparison_adapter
...
# Milestone 4 compatibility surface.  The CLI names stay importable for downstream
# scripts and Benchmark 0, while the implementation now lives in headless services.
NUMERIC_FEATURE_SET = _comparison_adapter.NUMERIC_FEATURE_SET
BASE_FEATURES = _comparison_adapter.BASE_FEATURES
TIMING_FEATURES = _comparison_adapter.TIMING_FEATURES
NUMERIC_FEATURE_COUNT = _comparison_adapter.NUMERIC_FEATURE_COUNT
NUMERIC_FEATURE_NAMES = _comparison_adapter.NUMERIC_FEATURE_NAMES
FEATURE_UNITS = _comparison_adapter.FEATURE_UNITS
REASON_Z_THRESHOLD = _comparison_adapter.REASON_Z_THRESHOLD
SCORE_TOP_K = _comparison_adapter.SCORE_TOP_K
LOW_DIRECTION_WEIGHT = _comparison_adapter.LOW_DIRECTION_WEIGHT
LOW_DIRECTION_CAP = _comparison_adapter.LOW_DIRECTION_CAP
LOW_SIGNAL_FEATURES = _comparison_adapter.LOW_SIGNAL_FEATURES
SATURATING_FEATURES = _comparison_adapter.SATURATING_FEATURES
MIN_BASELINE_SESSIONS = _comparison_adapter.MIN_BASELINE_SESSIONS
BASELINE_EXEMPT_FEATURES = _comparison_adapter.BASELINE_EXEMPT_FEATURES
BASELINE_SCALE_FLOOR = _comparison_adapter.BASELINE_SCALE_FLOOR
LOCAL_ORG = _comparison_adapter.LOCAL_ORG
HOST_OUTBOUND_FEATURES = _comparison_adapter.HOST_OUTBOUND_FEATURES
HOST_OUTBOUND_UNITS = _comparison_adapter.HOST_OUTBOUND_UNITS
HOST_OUTBOUND_GLOSS = _comparison_adapter.HOST_OUTBOUND_GLOSS
build_baseline_centers = _comparison_adapter.build_baseline_centers  # noqa: F811
deviation_score = _comparison_adapter.deviation_score  # noqa: F811
host_relative_gloss = _comparison_adapter.host_relative_gloss  # noqa: F811
build_numeric_features = _comparison_adapter.build_numeric_features  # noqa: F811
_transform_numeric_feature = _comparison_adapter._transform_numeric_feature  # noqa: F811
transform_numeric_features = _comparison_adapter.transform_numeric_features  # noqa: F811
_robust_center_scale = _comparison_adapter._robust_center_scale  # noqa: F811
robust_z_scores = _comparison_adapter.robust_z_scores  # noqa: F811
baselined_z_scores = _comparison_adapter.baselined_z_scores  # noqa: F811
score_endpoints = _comparison_adapter.score_endpoints  # noqa: F811
score_host_outbound = _comparison_adapter.score_host_outbound  # noqa: F811
build_feature_matrix = _comparison_adapter.build_feature_matrix  # noqa: F811
